                    ...
                    >
                                ...
                                <FormControl >
                                    <SimpleGrid columns = {2} mt = {10} spacing = {10}>
                                        <Select id='topic' value={this.state.quizTopic} onChange={this.handleSelect}>
                                            {topics.map((topic) => (
                                                <option key={topic.id} value={topic.value}>{topic.label}</option>
                                            ))}
                                        </Select>
                                        <Select id='dif' value={this.state.quizDifficulty} onChange={this.handleSelect}>
                                            {difficulties.map((diff) => (
                                                <option key={diff.id} value={diff.value}>{diff.label}</option>
                                            ))}
                                        </Select>
                                    </SimpleGrid>
                        ...
                        this.state.gameOver &&
                            <div>
                                ...
                                <Text fontSize='lg' mb={50}> You got {this.state.playerScore/this.state.quizLength*100}% or {this.state.playerScore}/{this.state.quizLength} questions correct.</Text>
